...
<body>
	...
	<div class="container" style=" border-style: solid; border-width: 2px; border-color: green; border-radius: 5px;">
		<br>
		<div class="form-group">
					<div class="col-sm-12">
					
						<label class="col-sm-offset-4" style="color: green;">The administrator have successfully registered into the system</label>
						</div>
				</div>
