	...
	<div class="container">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon2">First Name</span>
							<input type="text" class="form-control" placeholder="Enter Next Of Kin's First Name" aria-describedby="basic-addon1">
						</div>
					</div>
					...
					<div class = "col-lg-6">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon3">Surname</span>
							<input type="text" class="form-control" placeholder="Enter Next Of Kin's Surname" aria-describedby="basic-addon1">
						</div>
					</div>
				</div>
				<br>
				<div class="row">
					<div class="col-lg-12">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon2">Address</span>
							<input type="text" class="form-control" placeholder="Enter Next Of Kin's Address" aria-describedby="basic-addon1">
						</div>
					</div>
				</div>
				...
				<div class ="row">
					<div class="col-lg-6">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon2">City</span>
							<input type="text" class="form-control" placeholder="Enter Next Of Kin's City" aria-describedby="basic-addon1">
						</div>
					</div>
					<div class="col-lg-6">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon2">State</span>
							<input type="text" class="form-control" placeholder="Enter Next Of Kin's State" aria-describedby="basic-addon1">
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-8">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon2">Realtionship</span>
							<input type="text" class="form-control" placeholder="Enter Next Of Kin's Relation" aria-describedby="basic-addon1">
						</div>
					</div>
					...
					<div class="col-lg-4">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon2">Tel</span>
							<input type="text" class="form-control" placeholder="Enter Next Of Kin's Telephone" aria-describedby="basic-addon1">
						</div>
					</div>
					</div>
					<br>
					...
					<div class="col-lg-6">
						...
						<div class="col-lg-6">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon2">Radiographer's ID</span>
							<input type="text" class="form-control" placeholder="Enter Radiographer's First Name" aria-describedby="basic-addon1">
						</div>
					</div>
				</div>
				...
				<br>
					...
					<div class="col-lg-6">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon2">Radiographer's First Name</span>
							<input type="text" class="form-control" placeholder="Enter Radiographer's First Name" aria-describedby="basic-addon1">
						</div>
					</div>
					...
					<div class="col-lg-6">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon2">Radiographer's Last Name</span>
							<input type="text" class="form-control" placeholder="Enter Radiographer's Last Name" aria-describedby="basic-addon1">
						</div>
					</div>
				</div>
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" readonly>
					...
					<div class='row'>
						...
						<button type="button" class="btn btn-default" style="width: 320px; margin-left: 100px; height: 40px">Restart</button> 
					</div>
