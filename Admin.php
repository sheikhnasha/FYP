...
<body>
	...
	<div class="container">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="input-group">
							...
							<input type="email" name="adminEmail" class="form-control" placeholder="Enter Email Address">
						</div>
					</div>
		...
		border-width: 1px; margin-bottom: 10px; border-color: #D1D1D1">
				...
				<div class="col-sm-1">
				<div class="input-group">
				<h5><?php echo $row_admin['administratorsID'];?></h5>
				</div>
				</div>
				...
				<div class="col-sm-1"  id="hide_button" style="display: none;" >
				<div class="input-group">
				<button style="width:70px;" class="btn btn-default" onclick="hide()">Cancel</button>
				...
				<div class="col-sm-1">
				<div class="input-group">
				<button style="width:70px;" id="edit_button" class="btn btn-default" onclick="show()">Edit</button>
				...
				<form class="form-horizontal" id="see_edit" method="post" enctype="multipart/form-data" style="display: none;">
				<br>
				<div class="row">
					<div class="col-lg-6">
						<div class="input-group">
				...
				<br>
					...
					<div class='row'>
						...
						<button  type="submit" value="Upload Image" name="Submit" class="btn btn-primary" style="width: 320px; height: 40px">Update</button> 
					</div>
					</form>
